...
export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <head>
    ...
    <title>Welcome to ConnectPro</title>
  </head>
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(to right, #B98DD4, #2A2996); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
      <img src="https://api-us-1.we-connect.io/storage/whitelabel/17_5fc894612b9f83-48240106.png" alt="ConnectPro Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;">
      <h1 style="color: white; margin: 0; font-size: 28px;">Welcome to ConnectPro!</h1>
    </div>
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      <p style="font-size: 18px; color: #0077B5;"><strong>Hello ${name},</strong></p>
      <p>We're thrilled to have you join our professional community! ConnectPro is your platform to connect, learn, and grow in your career.</p>
      ...
      <p>Best regards,<br>The ConnectPro Team</p>
    </div>
  </body>
  </html>
  `;
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #B98DD4, #2A2996); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
    <img src="https://img.freepik.com/premium-vector/linkedin-logo_578229-227.jpg" alt="ConnectPro Logo" style="width: 150px; margin-bottom: 20px;border-radius: 10px;"/>
  ...
  <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
    ...
    <p>Great news! <strong>${recipientName}</strong> has accepted your connection request on ConnectPro.</p>
    <div style="background-color: #f3f6f8; padding: 20px; border-radius: 8px; margin: 20px 0;">
